...
export function FederalCompetitions({ competitions, user }: { competitions: Competition[], user: any }) {
  ...
  const federalCompetitions = competitions.filter(c => c.type === 'federal');

  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Федеральные мероприятия</h2>
